...
const { name, description, footer, socials } = useAppConfig()
  ...
  <div class="border-t border-gray-200 dark:border-gray-800 ">
    <footer class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-20 md:pb-30 flex flex-col gap-12 md:gap-20 rounded-lg">
      ...
      <div class="text-sm dark:text-gray-400 text-center">
        <span class="capitalize font-medium">{{ name }}</span> is part of the <NuxtLink to="https://unjs.io" rel="noopener" class="hover:underline underline-offset-2">
          UnJS ecosystem
        </NuxtLink> · Documentation design powered by <NuxtLink to="https://ui.nuxt.com/pro" rel="noopener" class="hover:underline underline-offset-2">
